    ...
    <div>
      ...
      <section className="grid grid-cols-1 border-b border-[#e5e5e5] md:grid-cols-2">
        <div className="flex flex-col justify-center p-12 md:p-16">
          ...
          <h1 className="font-serif text-[34px] leading-[1.2] whitespace-pre-line text-[#111]">
            {t('about.title')}
          </h1>
        </div>
      ...
      <section className="border-t border-[#e5e5e5]">
        <p className="px-7 py-5 text-[10px] tracking-[0.12em] text-[#aaa] uppercase">
          {t('about.values')}
        </p>
        <div className="grid grid-cols-1 border-t border-[#e5e5e5] md:grid-cols-3">
          {values.map((v, i) => (
            ...
            >
              <p className="mb-3 font-serif text-[28px] text-[#e0dbd2]">
                0{i + 1}
              </p>
              <h3 className="mb-2 text-[15px] text-[#111]">{t(v.title)}</h3>
              <p className="text-[13px] leading-relaxed font-light text-[#888]">
                {t(v.body)}
              </p>
            </div>
          ))}
      ...
      <section className="flex flex-col items-center gap-6 border-t border-[#e5e5e5] py-20">
        <h2 className="font-serif text-[24px] text-[#111]">Butter Weather</h2>
        <Link
          href="/products"
